...
<html lang="en">
  ...
  <body>
    <h1 class ="container text-center">About Us</h1>
    ...
    <div class="container">
        <div class="text1">
            <h1 >Our mission</h1>
            <p> We want to be able to learn people how to cook our delicious meals,
               so we made that possible by going into a building in the evening when its not used</p>
  ...
  <div class="container">
    ...
    <div class="text2">
        <h1 >Our succeses</h1>
        <p>We have succesfully created a restaurant chain in at the most beatifull places in Amsterdam,
